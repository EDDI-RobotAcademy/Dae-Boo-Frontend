    ...
    <div class="readBack">
        ...
        <table>
            ...
            <tr>
                <td>카테고리</td>
                <td>
                    <input type="text" :value="board.category" readonly/>
                </td>
            </tr>
            <tr>
                <td>제목</td>
                <td>
                    <input type="text" :value="board.boardName" readonly/>
                </td>
            </tr>
            <tr>
                <td>작성자</td>
                <td>
                    ...
                    <input type="text" v-if="board.writer" :value="board.writer" readonly/>
